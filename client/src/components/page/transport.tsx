...
import { getLinkEnabled } from "../../selectors/linkAudio";
						...
						<Group gap="xs" align="center" wrap="nowrap" justify="space-between">
							...
							<Group gap="xs" align="center" wrap="nowrap">
								<Tooltip label="Toggle Jack transport sync to Ableton Link" refProp="rootRef">
									<Switch onChange={ onLinkSyncToggle } name="linksync" checked={ controlState.linkSync } disabled={ !linkEnabled } label="Link" labelPosition="left" size="md"/>
								</Tooltip>
